...
public interface OrderHistoryBotRepository extends JpaRepository<OrderHistoryBot, Integer>, Serializable {

	@Query("select ohb from OrderHistoryBot ohb where ohb.user.id = :iduser ")
